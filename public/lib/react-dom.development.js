 ...
 */
  var ChangeEventPlugin = {
    ...
    extractEvents: function (topLevelType, targetInst, nativeEvent, nativeEventTarget) {
      ...
      var getTargetInstFunc; var handleEventFunc;
 ...
 */
  ...
  var ReactFiberBeginWork = function (config, hostContext, hydrationContext, scheduleWork, computeExpirationForFiber) {
    ...
    var shouldDeprioritizeSubtree = config.shouldDeprioritizeSubtree;
    var pushHostContext = hostContext.pushHostContext;

      
    var pushHostContainer = hostContext.pushHostContainer;
    var enterHydrationState = hydrationContext.enterHydrationState;

      
    var resetHydrationState = hydrationContext.resetHydrationState;

      
    var tryToClaimNextHydratableInstance = hydrationContext.tryToClaimNextHydratableInstance;
  ...
  */
  ...
  var ReactFiberCompleteWork = function (config, hostContext, hydrationContext) {
    ...
    var getHostContext = hostContext.getHostContext;
    ...
    var prepareToHydrateHostTextInstance = hydrationContext.prepareToHydrateHostTextInstance;

      
    var popHydrationState = hydrationContext.popHydrationState;
    ...
    if (mutation) {
      ...
      // Persistent host tree mode
        ...
        var createContainerChildSet = persistence.createContainerChildSet;

          
        var appendChildToContainerChildSet = persistence.appendChildToContainerChildSet;

          
        var finalizeContainerChildren = persistence.finalizeContainerChildren;
  ...
  var ReactFiberCommitWork = function (config, captureError) {
    ...
    var commitUpdate = mutation.commitUpdate;

      
    var resetTextContent = mutation.resetTextContent;

      
    var commitTextUpdate = mutation.commitTextUpdate;

      
    var appendChild = mutation.appendChild;

      
    var appendChildToContainer = mutation.appendChildToContainer;

      
    var insertBefore = mutation.insertBefore;

      
    var insertInContainerBefore = mutation.insertInContainerBefore;

      
    var removeChild = mutation.removeChild;

      
    var removeChildFromContainer = mutation.removeChildFromContainer;
  ...
  var ReactFiberHydrationContext = function (config) {
    ...
    var hydration = config.hydration;
    ...
    var canHydrateTextInstance = hydration.canHydrateTextInstance;

      
    var getNextHydratableSibling = hydration.getNextHydratableSibling;

      
    var getFirstHydratableChild = hydration.getFirstHydratableChild;

      
    var hydrateInstance = hydration.hydrateInstance;

      
    var hydrateTextInstance = hydration.hydrateTextInstance;

      
    var didNotMatchHydratedContainerTextInstance = hydration.didNotMatchHydratedContainerTextInstance;

      
    var didNotMatchHydratedTextInstance = hydration.didNotMatchHydratedTextInstance;

      
    var didNotHydrateContainerInstance = hydration.didNotHydrateContainerInstance;

      
    var didNotHydrateInstance = hydration.didNotHydrateInstance;

      
    var didNotFindHydratableContainerInstance = hydration.didNotFindHydratableContainerInstance;

      
    var didNotFindHydratableContainerTextInstance = hydration.didNotFindHydratableContainerTextInstance;

      
    var didNotFindHydratableInstance = hydration.didNotFindHydratableInstance;

      
    var didNotFindHydratableTextInstance = hydration.didNotFindHydratableTextInstance;
  ...
  var ReactFiberScheduler = function (config) {
    ...
    var beginFailedWork = _ReactFiberBeginWork.beginFailedWork;
    ...
    var commitResetTextContent = _ReactFiberCommitWork.commitResetTextContent;

      
    var commitPlacement = _ReactFiberCommitWork.commitPlacement;
    ...
    var commitAttachRef = _ReactFiberCommitWork.commitAttachRef;

      
    var commitDetachRef = _ReactFiberCommitWork.commitDetachRef;
    ...
    var cancelDeferredCallback = config.cancelDeferredCallback;
  ...
  var ReactFiberReconciler$1 = function (config) {
    ...
    var computeAsyncExpiration = _ReactFiberScheduler.computeAsyncExpiration;

      
    var computeExpirationForFiber = _ReactFiberScheduler.computeExpirationForFiber;
    ...
    var unbatchedUpdates = _ReactFiberScheduler.unbatchedUpdates;

      
    var flushSync = _ReactFiberScheduler.flushSync;

      
    var deferredUpdates = _ReactFiberScheduler.deferredUpdates;
